...
#
echo ifdh cp -D $RES/$VIN/$INPUT_PERM_FILE $CONDOR_DIR_INPUT >> $log
ifdh cp -D $RES/$VIN/$INPUT_PERM_FILE $CONDOR_DIR_INPUT >> $log 2>&1
echo >> $log
echo ifdh cp -D $RES/$VIN/$INPUT_FILE $CONDOR_DIR_INPUT >> $log
ifdh cp -D $RES/$VIN/$INPUT_FILE $CONDOR_DIR_INPUT >> $log 2>&1
echo >> $log
#
