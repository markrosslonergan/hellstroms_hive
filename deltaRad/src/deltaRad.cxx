...
//		bdt_app(bnb_bdt_info, app_files, vars, TMVAmethods);
		...
		obs.plotBDTStacks(ftest,cosmic_bdt_info.identifier, fcoscut, fbnbcut);
	...
	//	datamc2.plotBDTStacks(ftest, bnb_bdt_info.identifier ,fcoscut,fbnbcut);
		...
		//datamc3.plotBDTStacks(ftest, bnb_bdt_info.identifier ,fcoscut,fbnbcut);
		//datamc3.plotBDTStacks(ftest, cosmic_bdt_info.identifier ,fcoscut,fbnbcut);
