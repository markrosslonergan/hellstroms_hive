...
*/
    ...
    // double angle_increment = 360/n_increments;
     
     bdt_variable v_reco_shower_dedx_plane2 (s_reco_shower_dedx_plane2,"(48,0,6.5)", "Median Shower dE/dx plane 2 [MeV/cm]",false,"d");
     validateOverlay({v_reco_shower_dedx_plane2 },{bnb_cosmics}, {"reco_asso_showers>0 && sim_shower_is_true_shower && reco_shower_theta_yz[0] > -10 && reco_shower_theta_yz[0] < 10 "}, data5e19,"reco_asso_showers>0 && reco_shower_theta_yz[0] > -10 && reco_shower_theta_yz[0] < 10 ", "shower_dedx_plane2",true);
