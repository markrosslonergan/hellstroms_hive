...
std::vector<double> scan_significance(TFile * fout, std::vector<bdt_file*> sig_files, std::vector<bdt_file*> bkg_files, bdt_info cosmic_focused_bdt, bdt_info bnb_focused_bdt){
	...
	//Track Finer
	cut_min_cosmic = 0.55; cut_max_cosmic = 0.570;
	cut_min_bnb = 0.510; cut_max_bnb = 0.535;

	//Track Finer
	cut_min_cosmic = 0.5375; cut_max_cosmic = 0.542;
	cut_min_bnb = 0.525; cut_max_bnb = 0.53;
