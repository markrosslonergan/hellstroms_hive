...
std::vector<double> scan_significance( std::vector<bdt_file*> sig_files, std::vector<bdt_file*> bkg_files, std::vector<bdt_info> bdt_infos){
    ...
    double scal_up = 1.02;
    double scal_down = 0.98;
//    std::vector<double> cval = {0.469232, 0.575191, 0.528824, 0.325369};
    double fcoscut = 0.542722;// 0.542626; //sig.1:ccut: 0.551752 0.581527  #signal: 24.1207 #bkg: 46.2715 ||  bnb: 46.2715 cos: 0 || impact 17.9759 3.54595
    double fbnbcut = 0.560427; //0.464029 0.558237
  ...
  for(size_t i = 0; i < sig_files.size(); ++i) {
    ...
    for(int t=0; t < 10000; t++){
            ...
            double impact = rangen->Uniform(16,19);
