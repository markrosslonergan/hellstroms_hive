...
variable_list::variable_list(std::string analysis_tag_in): analysis_tag(analysis_tag_in){
	...
	if(analysis_tag == "track" || analysis_tag == "notrack"){
		...
		all_vars.push_back(bdt_variable("totalpe_ibg_sum","(48,0,5000)","Total in Beam-Gate PE",false,"d"));  //1
        all_vars.push_back(bdt_variable("reco_shower_dedx_plane2[most_energetic_shower_index]","(48,0,15)", "Leading Shower dE/dx (Collection Plane) [MeV/cm]",false,"d"));
        all_vars.push_back(bdt_variable("reco_shower_dedx_plane2[second_most_energetic_shower_index]","(48,0,15)", "Subleading Shower dE/dx (Collection Plane) [MeV/cm]",false,"d"));
		all_vars.push_back(bdt_variable("reco_shower_length[0]","(48,0,100)","Leading Shower Length [cm]",false,"d"));//4
		all_vars.push_back(bdt_variable("reco_shower_length[1]","(48,0,100)","Subleading Shower Length [cm]",false,"d"));//4
		...
		all_vars.push_back(bdt_variable("cos(atan2(reco_shower_diry[second_most_energetic_shower_index],reco_shower_dirz[second_most_energetic_shower_index]))","(48,-second_most_energetic_shower_index,second_most_energetic_shower_index)","Reconstructed Subleading Shower - Cosine Theta", false,"d"));//8
		all_vars.push_back(bdt_variable("cos(atan2(reco_shower_diry[second_most_energetic_shower_index], reco_shower_dirx[second_most_energetic_shower_index]))","(48,-second_most_energetic_shower_index,second_most_energetic_shower_index)","Reconstructed Subleading Shower - Cosine Phi", false,"d"));//9

		all_vars.push_back(bdt_variable("reco_shower_endx[most_energetic_shower_index]","(48,0,250)"," Reconstructed Leading Shower End X pos [cm]",false,"d"));//10
		all_vars.push_back(bdt_variable("reco_shower_endy[most_energetic_shower_index]","(48,-110,+110)","Reconstructed Leading Shower End Y pos [cm]",false,"d"));//11
		all_vars.push_back(bdt_variable("reco_shower_endz[most_energetic_shower_index]","(48,0,1050)","Reconstructed Leading Shower End Z pos [cm]",false,"d"));//12
		all_vars.push_back(bdt_variable("reco_shower_endx[second_most_energetic_shower_index]","(48,0,250)"," Reconstructed Subleading Shower End X pos [cm]",false,"d"));//10
		all_vars.push_back(bdt_variable("reco_shower_endy[second_most_energetic_shower_index]","(48,-110,+110)","Reconstructed Subleading Shower End Y pos [cm]",false,"d"));//11
		all_vars.push_back(bdt_variable("reco_shower_endz[second_most_energetic_shower_index]","(48,0,1050)","Reconstructed Subleading Shower End Z pos [cm]",false,"d"));//12

		all_vars.push_back(bdt_variable( "fabs(atan2(reco_shower_diry[0],reco_shower_dirz[0]))/3.14159","(48,0,1.0)","Reconstucted Leading Shower Angle Beamy-ness [rad]","false","d")); //13
		all_vars.push_back(bdt_variable( "min(fabs(atan2(reco_shower_diry[0],reco_shower_dirx[0])+3.14159/2.0),fabs(atan2(reco_shower_diry[0],reco_shower_dirx[0])-3.14159/2.0))/3.14159","(48,0,0.5)","Reconstucted Leading Shower Angle Cosmicy-ness [rad]","false","d")); //14
        ...
        all_vars.push_back(bdt_variable("track_info.reco_track_kinetic_from_length[0]","(48,0,1)","Reconstructed Track Kinetic Energy (Length) [cm]", true,"d"));//37
        all_vars.push_back(bdt_variable("track_info.reco_track_kinetic_from_length[0]/track_info.reco_track_kinetic[0]","(48,0,5)","Ratio of Reco Track Kinetic (Length/Calo)", true,"d"));//38
        all_vars.push_back(bdt_variable("pi0Boost_info.gamma_pi_least_angle","(25, -0.1, 1.6)","Smallest #gamma $pi Angle (CM Frame)", true,"d"));//38
        all_vars.push_back(bdt_variable("pi0Boost_info.gamma_z_least_angle","(25, -0.1, 1.6)","Smallest #gamma z Angle (CM Frame)", true,"d"));//38
