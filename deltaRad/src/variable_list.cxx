...
variable_list::variable_list(std::string analysis_tag_in): analysis_tag(analysis_tag_in){
    ...
    std::string cm_angle = "(fabs("+E1+" - "+E2+")/("+p_pi+"))";
		...
		std::string track_length_cut = "reco_track_displacement[0]<1000";
		std::string min_shower_energy_cut = "reco_shower_energy[0]>0.0 ";
		std::string min_conversion_cut = "reco_shower_conversion_distance[0] > 0 && reco_shower_conversion_distance[1]>0";
    ...
    all_vars.push_back(bdt_variable(p_pi_x+"/1000", "(50, 0, 0.5)", "Reco. #pi^{0} x-Momentum [GeV]", false, "d"));
    //all_vars.push_back(bdt_variable(p_pi_y+"/1000", "(50, 0, 0.5)", "Reco. #pi^{0} y-Momentum [GeV]", false, "d"));
    //all_vars.push_back(bdt_variable(p_pi_z+"/1000", "(50, 0, 0.5)", "Reco. #pi^{0} z-Momentum [GeV]", false, "d"));
    all_vars.push_back(bdt_variable(invariant_mass, "(50, 0, 0.5)", "Reco. #pi^{0} Invariant Mass [GeV]", false, "d"));
    all_vars.push_back(bdt_variable(cm_angle, "(25, 0, 1.0)", "Reco. cos(#theta_{CM}) ", false, "d"));

		all_vars.push_back(bdt_variable("reco_flash_total_pe_in_beamgate[0]","(48,0,5000)","Total in Beam-Gate PE",false,"d"));  //1
		all_vars.push_back(bdt_variable("reco_shower_dEdx_plane2_median["+shower_index1+"]","(48,0,6.5)", "Median Leading Shower dE/dx plane 2 [MeV/cm]",false,"d")); //2
		all_vars.push_back(bdt_variable("reco_shower_dEdx_plane2_median["+shower_index2+"]","(48,0,6.5)", "Median Subleading Shower dE/dx plane 2 [MeV/cm]",false,"d")); //2
		all_vars.push_back(bdt_variable("reco_shower_energy["+shower_index1+"]/1000.0","(48,0,0.8)","Reco. Leading Shower Energy (Corrected) [GeV]", false,"d"));  //3
		all_vars.push_back(bdt_variable("reco_shower_energy["+shower_index2+"]/1000.0","(48,0,0.8)","Reco. Subleading Shower Energy (Corrected) [GeV]", false,"d"));  //3
		all_vars.push_back(bdt_variable("reco_shower_length["+shower_index1+"]","(48,0,100)","Leading Shower Length [cm]",false,"d"));//4
		all_vars.push_back(bdt_variable("reco_shower_length["+shower_index2+"]","(48,0,100)","Subleading Shower Length [cm]",false,"d"));//4

		all_vars.push_back(bdt_variable("reco_shower_opening_angle["+shower_index1+"]","(48,0,0.8)","Leading Shower Opening Angle",false,"d"));//5
		all_vars.push_back(bdt_variable("reco_shower_opening_angle["+shower_index2+"]","(48,0,0.8)","Subleading Shower Opening Angle",false,"d"));//5
		all_vars.push_back(bdt_variable(two_shower_opening_angle,"(48,-1.5,1.5)","Two-Shower Opening Angle",false,"d"));//5
		all_vars.push_back(bdt_variable("reco_shower_flash_shortest_distz["+shower_index1+"]","(48,0,520)","Distance from Leading Shower to Flashcenter [cm]",false,"d"));//6
		all_vars.push_back(bdt_variable("reco_shower_flash_shortest_distz["+shower_index2+"]","(48,0,520)","Distance from Subleading Shower to Flashcenter [cm]",false,"d"));//6

		//all_vars.push_back(bdt_variable("cos(reco_shower_theta_yz["+shower_index1+"])","(48,-1,1)","Reco. Leading Shower - Cosine Theta", false,"d"));//8
		//all_vars.push_back(bdt_variable("cos(reco_shower_theta_yz["+shower_index2+"])","(48,-1,1)","Reco. Subleading Shower - Cosine Theta", false,"d"));//8
		all_vars.push_back(bdt_variable("cos(reco_shower_phi_yx["+shower_index1+"])","(48,-1,1)","Reco. Leading Shower - Cosine Phi", false,"d"));//9
		all_vars.push_back(bdt_variable("cos(reco_shower_phi_yx["+shower_index2+"])","(48,-1,1)","Reco. Subleading Shower - Cosine Phi", false,"d"));//9
		//all_vars.push_back(bdt_variable("reco_shower_startx["+shower_index1+"]","(48,0,250)"," Reco. Leading Shower start X pos [cm]",false,"d"));//10
		//all_vars.push_back(bdt_variable("reco_shower_startx["+shower_index2+"]","(48,0,250)"," Reco. Subleading Shower start X pos [cm]",false,"d"));//10
		//all_vars.push_back(bdt_variable("reco_shower_starty["+shower_index1+"]","(48,0,120)"," Reco. Leading Shower start Y pos [cm]",false,"d"));//10
		//all_vars.push_back(bdt_variable("reco_shower_starty["+shower_index2+"]","(48,0,120)"," Reco. Subleading Shower start Y pos [cm]",false,"d"));//10
		all_vars.push_back(bdt_variable("reco_shower_startz["+shower_index1+"]","(50,0,1050)"," Reco. Leading Shower start Z pos [cm]",false,"d"));//10
		all_vars.push_back(bdt_variable("reco_shower_startz["+shower_index2+"]","(50,0,1050)"," Reco. Subleading Shower start Z pos [cm]",false,"d"));//10
    all_vars.push_back(bdt_variable("log10(reco_shower_conversion_distance["+shower_index1+"])","(48,-2,4)","Log Reco. Leading Shower conversion distance","false","d"));
    all_vars.push_back(bdt_variable("log10(reco_shower_conversion_distance["+shower_index2+"])","(48,-2,4)","Log Reco. Subleading Shower conversion distance","false","d"));
