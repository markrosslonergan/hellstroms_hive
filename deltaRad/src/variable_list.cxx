...
variable_list::variable_list(std::string analysis_tag_in): analysis_tag(analysis_tag_in){
    ...
    if(analysis_tag == "track" || analysis_tag == "notrack" || analysis_tag == "1g2p" ){
        ...
        plot_vars.push_back(bdt_variable("reco_shower_dQdx_plane2_median[0]","(36,0,400000)", "Median Shower dQ/dx plane 2 [MeV/cm]",false,"d")); //2
        plot_vars.push_back(bdt_variable("reco_shower_dQdx_plane1_median[0]","(36,0,400000)", "Median Shower dQ/dx plane 1 [MeV/cm]",false,"d")); //2
        plot_vars.push_back(bdt_variable("reco_shower_dQdx_plane0_median[0]","(36,0,400000)", "Median Shower dQ/dx plane 0 [MeV/cm]",false,"d")); //2
      ...
      //plot_vars.push_back(bdt_variable("reco_shower_delaunay_area_plane2[0]","(48,0,200e3)","Reconstructed Shower delaunay area plane 2","false","d"));
        ...
        plot_vars.push_back(bdt_variable("reco_shower_start_to_nearest_dead_wire_plane2[0]","(24,0,200)","Reconstructed Shower dead wire dist plane 2 pos [cm]",false,"d"));//12
        ...
        if(analysis_tag == "track"){
            ...
            train_vars.push_back(bdt_variable("reco_track_proton_kinetic_energy[reco_track_ordered_energy_index[1]]","(24,0,1)","Reconstructed Track Kinetic Energy 2nd [GeV]","true","d"));
