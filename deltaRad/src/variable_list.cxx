...
variable_list::variable_list(std::string analysis_tag_in): analysis_tag(analysis_tag_in){
    ...
    all_vars.push_back(bdt_variable(invariant_mass, "(25, 0, 0.5)", "Reco. #pi^{0} Invariant Mass [GeV]", false, "d"));
    all_vars.push_back(bdt_variable(cm_angle, "(25, 0, 1.0)", "Reco. cos(#theta_{CM}) ", false, "d"));
		...
		all_vars.push_back(bdt_variable("reco_shower_opening_angle["+shower_index2+"]","(25,-1.0,1.0)","Subleading Shower Opening Angle",false,"d"));//5
