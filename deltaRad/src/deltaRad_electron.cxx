...
int main (int argc, char *argv[]){
    ...
    std::string dir2 = "/pnfs/uboone/persistent/users/markross/single_photon_persistent_data/vertexed_v2/";
   ...
   // bdt_file *signal_cosmics = new bdt_file(dir, "vertexed_ncdeltaradcosmics_fresh_v4.1.root", "LEENue", "hist","",  kCyan-3, signal_flow);
	...
	for(auto &f: bdt_files){
	    ...
	    addPreFriends(f,"pi0");
	    if(f->tag == "LEEunfolded" || f->tag == "LEEunfoldedCosmics") f->tvertex->AddFriend("lee_unfolding_tree",
		"/pnfs/uboone/persistent/users/markross/single_photon_persistent_data/vertexed_v3/friends/Unfolded_LEE_scaled_NueIntrinsicCosmics.root");
