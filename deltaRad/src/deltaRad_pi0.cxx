...
int main (int argc, char *argv[]){
    ...
    std::cout << "vec_precuts size = " << vec_precuts.size() << std::endl;
	...
	for(auto &f: bdt_files){
		std::cout<<"Loading "<<f->tag<<"\t with "<<f->tvertex->GetEntries()<<"\t vertices. (unweighted)"<<std::endl;
	...
	std::cout<<" If you see warnings, but haven't yet run app stage, thats ok!            "<<std::endl;
	std::cout<<"--------------------------------------------------------------------------"<<std::endl;
