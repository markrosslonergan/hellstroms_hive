...
int bdt_stack::plotStacks(TFile *ftest, std::vector<bdt_variable> vars, double c1, double c2){
    ...
    for(int s = 0; s< 4; s++){
        ...
        for(auto &var: vars){
            ...
            TText *tbdt2 = drawPrelim(0.11,0.91,0.035,"MicroBooNE Simulation");
            tbdt2->Draw();
...
int bdt_stack::plotStacks(TFile *ftest, bdt_variable var,double c1, double c2){
    ...
    TText *tsel = drawPrelim(0.16,0.91,0.035,"MicroBooNE Simulation");
    tsel->Draw();
    ...
    TLegend *l1 = new TLegend(0.11,0.60,0.89,0.89);
    l1->SetFillStyle(0);
    ...
    TText *tpre = drawPrelim(0.11,0.91,0.035,"MicroBooNE Simulation");
    tpre->Draw();
    ...
    TLegend *l2 = new TLegend(0.11,0.60,0.89,0.89);
    ...
    TText *tbdt1 = drawPrelim(0.11,0.91,0.035,"MicroBooNE Simulation ");
    tbdt1->Draw();
