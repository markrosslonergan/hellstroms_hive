...
struct bdt_file{
    public:
        ...
        TH1* getTH1Slice(std::string invar, std::string cuts, std::string nam, double plot_POT, int rebin);
         
        TH1* getTH1(bdt_variable var, std::string cuts, std::string nam, double plot_POT, int rebin);
        TH1* getTH1Slice(bdt_variable var, std::string cuts, std::string nam, double plot_POT, int rebin);
       

        TH1* getTH1(bdt_variable var, std::string cuts, std::string nam, double plot_POT);
        TH1* getTH1Slice(bdt_variable var, std::string cuts, std::string nam, double plot_POT);
