...
echo "Running gLEE 1g1p Near sideband on file "
echo $1
echo "With Tag"
echo $2
...
echo "Making XML"
sed "s@FULLPATH@$1@g"  /uboone/app/users/markrl/SL7test0/hellstroms_hive/hive/other/NearSidebands/1g1p_nearsideband_external_template_v1.xml > "1g1p_nearsideband_external_SED_"$2"_v1.xml"
sed -i "s@TAGTAG@$2@g" "1g1p_nearsideband_external_SED_"$2"_v1.xml"
...
/uboone/app/users/markrl/SL7test0/hellstroms_hive/hive/build/bin/hive_nearside_version -x /uboone/app/users/markrl/SL7test0/hellstroms_hive/hive/xml/1g1p_xmls/hive4.0/1g1p_EmeraldWorldOrder_CombinedRuns13_v4_Plot.xml -s 1 --extapp "1g1p_nearsideband_external_SED_"$2"_v1.xml" --cuts "(1g1pMar2020_v4Nue_mva >= 0.3 && (1g1pMar2020_v4BNB_mva >= 0.96273 && 1g1pMar2020_v4NCPi0_mva >= 0.467404) && 1g1pMar2020_v4SSVredo2wCC600parent_mva < 0.55)"   &> "gLEE_nearsideband_"$2".log"
