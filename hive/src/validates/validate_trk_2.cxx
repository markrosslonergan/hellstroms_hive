...
*/
    std::string dir = "/pnfs/uboone/persistent/users/markross/single_photon_persistent_data/";
    ...
    std::string base_cuts = "reco_vertex_size==1 && reco_asso_tracks > 0";
    ...
    bdt_file* ncdelta = new bdt_file(dir,  "vertexed_mcc9_v33/Test/ncdeltarad_overlay_test_run1_v33.0.root","NCDeltaRadOverlay", "hist", "singlephotonana/", kRed ,signal_flow );
