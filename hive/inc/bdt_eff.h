...
class bdt_efficiency{
    public:
        ...
        bdt_efficiency(bdt_file* filein, std::vector<std::string> v_denomin, std::vector<std::string> v_topo, std::vector<std::string> v_precuts , std::vector<double> bdt_cuts, double plot_POT,bool,int, std::string tag, bool pretopo, bool is0p, std::vector<bdt_variable> tmp_vars);
